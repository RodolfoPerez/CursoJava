...
```
cd existing_repo
git remote add origin https://gitlab.com/prueba4554329/prueba.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/prueba4554329/prueba/-/settings/integrations)
